...
class RoundRobin:
    ...
    def schedulingProcess(self, process_data, time_slice):
        ...
        while 1:
            ...
            if len(ready_queue) != 0:
                ...
                # If process has remaining burst time greater than the time slice
                # It will execute for a time period equal to time slice and then switch
    ...
    def printData(self, process_data, average_turnaround_time, average_waiting_time, executed_process):
        ...
        print("Process ID  Arrival Time  Remainding Burst Time   Completed  Original Burst Time  Completion Time  Turnaround Time  Waiting Time")
        for i in range(len(process_data)):
